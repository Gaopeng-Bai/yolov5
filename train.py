...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5m.yaml', help='model.yaml path model:yolov5s, yolov5m, yolov5x, yolov5l')
    ...
    parser.add_argument('--name', default='uta500x', help='save to project/name')
